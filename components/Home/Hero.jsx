...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="bg-cover container bg-center h-[600px] w-full flex items-center justify-center mx-auto">
        <div className="w-[80%]">
          <div className="text-center px-4 py-12">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              <button
                className="bg-[#5044e5] text-white px-6 py-3 rounded-md hover:bg-[#3e37c8] transition"
