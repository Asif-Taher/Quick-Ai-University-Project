            ...
            <div className='flex flex-wrap mt-10 justify-center'>
                {
                    dummyTestimonialData.map((Testimonial, index) => (
                        <div key={index} className='p-8 max-w-xs m-2 rounded-sm bg-[#FDFDFE99] cursor-pointer shadow-lg hover: translate-y-1 transition-all'>
                            ...
                            <hr className='text-[#C7C7C7] border border-solid border-[#C7C7C7]'/>
                            <div className='flex items-center gap-1 mt-4'>
                                <img src={Testimonial.image} alt="" className='w-10 h-10 rounded-full'/>
                                <div>
